    ...
    <div className="min-h-screen bg-white">
      ...
      {featured.length > 0 && (
        <section className="py-20 bg-white">
          <div className="mx-auto max-w-7xl px-6 lg:px-12">
            <FadeContent>
              <h2 className="text-4xl font-bold text-[#1C3364] mb-12">Uitgelichte Artikelen</h2>
            </FadeContent>
              ...
              {featured.map((post, index) => (
                <ScaleIn key={post.slug} delay={index * 0.1}>
                  <CardSpotlight className="h-full group">
                    <div className="h-64 bg-gradient-to-br from-[#1C3364]/20 to-[#F37325]/20 rounded-t-xl" />
                    <div className="p-8 space-y-4">
                      ...
                      <h3 className="text-2xl font-bold text-[#1C3364] group-hover:text-[#F37325] transition-colors">
                        <Link href={`/blog/${post.slug}`}>{post.title}</Link>
                      </h3>
                      
                      <p className="text-gray-600 leading-relaxed">{post.excerpt}</p>
                      
                      <Button className="mt-4 bg-[#F37325] hover:bg-[#F37325]/90" asChild>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <FadeContent>
            <h2 className="text-4xl font-bold text-[#1C3364] mb-12">
